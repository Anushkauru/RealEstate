...
<html lang="en">
  <head>
    <title>Wood Information &mdash;</title>
    <meta charset="utf-8">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/image1.jpg);" data-aos="fade" id="home-section">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
		  ...
		  <img src="images/wood.png" style="width:200px">
            <h1>Wood Availability Information</h1>
...
$records = mysqli_query($con,"SELECT * FROM materialadmin where MaterialName='Wood'");
