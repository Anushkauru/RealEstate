...
<html lang="en">
  <head>
    <title>Other Information &mdash;</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
		  ...
		  <img src="images/crane.png" style="width:200px">
            <h1>Other's Availability Information</h1>
...
$records = mysqli_query($con,"SELECT `id`, `MaterialName`, `Manufacturer`, `Quantity`, `AmountPerUnit`, `Cost` FROM `materialadmin` WHERE MaterialName LIKE 'G%' OR MaterialName LIKE 'S%' OR MaterialName LIKE 'B%';
");
...
<html>
    <head>
        <title> Material Availability Data </title>
    </head>
...
<?php
     ...
     while ($materialadmin = mysqli_fetch_assoc($records)){
           ...
           echo "<tr>";
               echo "<td>".$materialadmin['id']."</td>";
               echo "<td>".$materialadmin['MaterialName']."</td>";
