...
<input type="text" name="CustomerAadharNumber" placeholder="Enter Aadhar Number"/></p><br>
<p><input type="submit" name="Search" value="Search Data"/></p>
</fieldset >
</form>
</div>
...
//select 
$db= mysqli_select_db($conn,'realestate');
//if user 
if(isset($_POST['Search']))
{
	$id=$_POST['CustomerAadharNumber'];
	//display information
	$query="SELECT  * FROM customerbasicinformation where AadharNumber='$id' ";
	$query_run=mysqli_query($conn,$query);
	while($row= mysqli_fetch_array($query_run))
	{
		?>
			<form action="" method="POST">
				<input type="hidden" name="CustomerAadharNumber" value="<?php echo $row['AadharNumber'] ?>"/><br>
				<input type="text" name="CustomerName" value="<?php echo $row['CustomerName'] ?>"/><br>
				<input type="text" name="CustomerAddress" value="<?php echo $row['CustomerAddress'] ?>"/><br>
				<input type="text" name="CustomerContactNumber" value="<?php echo $row['ContactNumber'] ?>"/><br>
				<input type="text" name="CustomerEmailID" value="<?php echo $row['EmailID'] ?>"/><br>
				<input type="text" name="DateOfBirth" value="<?php echo $row['DateOfBirth'] ?>"/><br>
				<input type="text" name="CustomerAddressProof" value="<?php echo $row['AddressProof'] ?>"/><br>
				<input type="text" name="CustomerIdentityProof" value="<?php echo $row['IdentityProof'] ?>"/><br>
				<input type="text" name="CustomerProfession" value="<?php echo $row['Profession'] ?>"/><br>
				<input type="text" name="Requirements" value="<?php echo $row['Requirements'] ?>"/><br>
