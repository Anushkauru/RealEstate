...
<html lang="en">
  <head>
    <title>Check Cement Availability &mdash;</title>
    <meta charset="utf-8">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/image1.jpg);" data-aos="fade" id="home-section">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
		  ...
		  <img src="images/truck.png" style="width:200px">
            <h1>Cement Availability Information</h1>
...
//show details of cement information
$records = mysqli_query($con,"SELECT * FROM materialadmin where MaterialName='Cement'");
